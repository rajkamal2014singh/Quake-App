...
public final class QuerryUtils {
    ...
    /**
     * Create a private constructor because no one should ever create a {@link QuerryUtils} object.
    ...
    public static ArrayList<Data> extractEarthquakes() {
        ...
        // Create an empty ArrayList that we can start adding earthquakes toArrayList<Data> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            JSONArray jsonArrayFeatures = jsonRootObject.getJSONArray("features");

            //Iterate the jsonArray and print the info of JSONObjects
            for(int i=0; i < jsonArrayFeatures.length(); i++){
                JSONObject JSONObject1 = jsonArrayFeatures.getJSONObject(i);
                ...
                //long time = Long.parseLong(propertiesObject.optString("time").toString());   //OR
...
//                String dateToDisplay = dateFormatter.format(dateObject);
                ...
                Data newData = new Data(magnitude,place,time,URL);
                earthquakes.add(newData);
            }
